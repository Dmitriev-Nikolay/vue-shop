export const Basement = {
    ...
    <div class="footer-title-contacts">
        <h2 class="footer-title">vue-shop</h2>
    </div>
...
<div class="title-list">Контакты</div>
    <li class="footer-list-item-skype"><a class="a-footer" href="https://www.skype.com/ru/"> vue-shop_skype</a></li>
    <li class="footer-list-item-mail"><a class="a-footer" href="mailto:psdhtmlcss@mail.ru"> vue-shopM@mail.ru</a></li>
